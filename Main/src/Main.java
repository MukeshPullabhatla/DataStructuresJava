...
//		int confidence = (num * 100)/den;
	...
	private static void readAttributes() {
		try {
			input = new Scanner(new File("D:\\UNC_CHARLOTTE_2ND_SEMESTER\\CloudComputingInDataAnalysis\\Nov10\\AssignmentLERS\\attribute.txt"));
	...
	private static void readData() {
		try {
			input = new Scanner(new File("D:\\UNC_CHARLOTTE_2ND_SEMESTER\\CloudComputingInDataAnalysis\\Nov10\\AssignmentLERS\\data.txt"));
			int lineNo = 0;
